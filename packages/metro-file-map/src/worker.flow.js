...
import defaultDependencyExtractor from './lib/dependencyExtractor.flow';
import excludedExtensions from './workerExclusionList.flow';
...
function getHasteImpl(requestedModulePath: string): {
