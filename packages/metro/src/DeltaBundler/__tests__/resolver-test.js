    ...
    describe(osPlatform, () => {
      ...
      describe('relative paths', () => {
        ...
        it('resolves custom extensions in the correct order', async () => {
          ...
          expect(resolve(p('/root/index.js'), './a')).toBe(
            p('/root/a.another'),
          );
          end();
        ...
        ['browser', 'react-native'].forEach(browserField => {
          describe(`${browserField} field in package.json`, () => {
            ...
            it('resolves mappings without extensions', async () => {
              ...
              ).toBe(p('/root/node_modules/aPackage/client.js'));
            });
      ...
      describe('assets', () => {
        ...
        it('resolves asset files with resolution suffixes', async () => {
          ...
          expect(resolver.resolve(p('/root/index.js'), './b.png')).toBe(
            p('/root/b@.7x.png'),
          );
        ...
        it('resolves asset files with platform and resolution', async () => {
          setMockFileSystem({
            'index.js': '',
            'a.png': '',
            'a.ios.png': '',
      ...
      describe('global packages', () => {
        ...
        it('works with custom main fields', async () => {
          ...
          ).toBe(p('/root/aPackage/left-pad-custom.js'));
        });
      });
