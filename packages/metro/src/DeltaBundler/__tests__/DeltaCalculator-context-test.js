...
describe('DeltaCalculator + require.context', () => {
  ...
  it('removing a file from a context marks the context as modified', async () => {
    // Initial build
  ...
  it('adding a file to a context marks the context as modified', async () => {
    // Initial build
    await deltaCalculator.getDelta({reset: false, shallow: false});
  ...
  it('modifying an existing file in a context does not mark the context as modified', async () => {
    // Initial build
    await deltaCalculator.getDelta({reset: false, shallow: false});
  ...
  it('modifying a potential match of a context, without adding it, does not trigger a rebuild', async () => {
    // Initial build
    await deltaCalculator.getDelta({reset: false, shallow: false});
  ...
  it('adding a file to a context, and immediately modifying it, marks the context as modified', async () => {
    // Initial build
    await deltaCalculator.getDelta({reset: false, shallow: false});
  ...
  it('adding a file to a context, and immediately removing it, does not trigger a rebuild', async () => {
    // Initial build
    await deltaCalculator.getDelta({reset: false, shallow: false});
  ...
  it('removing a file from a context, and immediately adding it back, only rebuilds the file itself', async () => {
    // Initial build
    await deltaCalculator.getDelta({reset: false, shallow: false});
  ...
  it('modifying an existing file in a context, and immediately removing it, marks the context as modified', async () => {
    // Initial build
    await deltaCalculator.getDelta({reset: false, shallow: false});
