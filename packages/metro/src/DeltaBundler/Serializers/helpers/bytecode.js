...
import type {Module, Dependency} from '../../types.flow';
...
function wrapModule(module: Module<>, options: Options): Buffer {
  ...
  const ids = Array.from(module.dependencies.values()).map(
        ...
        : // Re-create buffers after losing the Buffer instance when sending data over workers.
          {
            ...
            data: {
              ...
              sourcemap: Buffer.from(output.data.sourcemap.data),
            },
          },
    );
